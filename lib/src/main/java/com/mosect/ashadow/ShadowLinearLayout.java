...
public class ShadowLinearLayout extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            shadowInfo.setShadowX(ta.getDimension(R.styleable.ShadowLinearLayout_Layout_layout_shadowX, 0f));
            shadowInfo.setShadowY(ta.getDimension(R.styleable.ShadowLinearLayout_Layout_layout_shadowY, 0f));
            shadowInfo.setShadowRadius(ta.getDimension(R.styleable.ShadowLinearLayout_Layout_layout_shadowRadius, 0f));
            shadowInfo.setShadowColor(ta.getColor(R.styleable.ShadowLinearLayout_Layout_layout_shadowColor, Color.BLACK));
            ...
            shadowInfo.setSolidColor(ta.getColor(R.styleable.ShadowLinearLayout_Layout_layout_solidColor, Color.BLACK));
            ta.recycle();
            init();
        }
